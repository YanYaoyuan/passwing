...
public slots:
    ...
    //设置背景颜色
    void setBgColor(QColor offColor, QColor onColor);
    //设置滑块颜色
    void setSliderColor(QColor offColor, QColor onColor);
    //设置文本颜色
    void setTextColor(QColor offColor, QColor onColor);

    //设置文本
    void setText(QString offText, QString onText);

    //设置背景图片
    void setImage(QString offImage, QString onImage);
    ...
    void setProperty(const QString,const int);
