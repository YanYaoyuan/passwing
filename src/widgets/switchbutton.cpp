...
SwitchButton::SwitchButton(QWidget *parent): QWidget(parent)
{
    ...
    bgColorOff = QColor(255, 255, 255);
    bgColorOn = QColor(255, 255, 255);

    sliderColorOff = QColor(100, 100, 100);
    sliderColorOn = QColor(0, 255, 255);

    textColorOff = QColor(10, 10, 10);
...
void SwitchButton::setChecked(bool value)
{
    if (checked != value) {
        checked = value;
...
void SwitchButton::setBgColor(QColor offColor, QColor onColor)
{
    bgColorOff = offColor;
    bgColorOn = onColor;
    update();
...
void SwitchButton::setSliderColor(QColor offColor, QColor onColor)
{
    sliderColorOff = offColor;
    sliderColorOn = onColor;
    update();
}

void SwitchButton::setTextColor(QColor offColor, QColor onColor)
{
    textColorOff = offColor;
    textColorOn = onColor;
    update();
}

void SwitchButton::setText(QString offText, QString onText)
{
    textOff = offText;
    textOn = onText;
    update();
...
void SwitchButton::setImage(QString offImage, QString onImage)
{
    imageOff = offImage;
    imageOn = onImage;
    update();
...
void SwitchButton::setSpace(int value)
{
    space = value;
    update();
}

void SwitchButton::setRectRadius(int radius)
{
    rectRadius = radius;
    update();
}
void SwitchButton::setProperty(const QString name,const int ind){
    proName = name;
